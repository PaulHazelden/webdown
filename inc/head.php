<!doctype html>
<!-- Standard page text generated by head.php 31 December 2023 -->
<?php
   ...
   $bread = substr($file1, $mainpos);
   $breadpos = strlen($bread) - 9;
   $bread = substr($bread, 0, $breadpos);
#   echo "<p>file1: $file1 </p>\n";
#   echo "<p>maindir: $maindir </p>\n";
#   echo "<p>bread: $bread </p>\n";
